              ...
              <li className="">
                <article className="border border-gray-500 bg-[rgb(35,38,45)] p-5 outline-pink-light transition-transform duration-300 ease-out focus-within:outline hover:scale-[1.03]">
                  ...
                  >
                    ...
                    {/* <img src="/_astro/webstorm-hero.5735f10b.webp" width="1500" height="643" alt="WebStorm announces official support for Astro" className="my-8" loading="lazy" decoding="async"> */}
