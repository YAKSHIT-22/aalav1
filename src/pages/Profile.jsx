...
const Profile = () => {
  ...
  return (
    <>
      ...
      <div class="flex lg:flex-row border-t border-gray-500 flex-col-reverse !text-gray-50">
        <aside class="border-inherit min-w-[30ch] lg:max-w-xs xl:max-w-sm lg:border-r border-t lg:border-t-0">
          <div class="p-6 lg:p-8 xl:p-10 lg:border-b border-gray-500 ">
            <h2 class="code ">Popular Challenges</h2>
            <ul class="mt-4 space-y-4 ">
              <li class="">
                <a
                  class="body link-underline border-pink-light text-lg text-pink-light "
                  href="/blog/2/"
                  rel="prefetch"
                >
                  Astro 2.0
              ...
              <li class="">
                <a
                  class="body link-underline border-pink-light text-lg text-pink-light "
                  href="/blog/introducing-content-collections/"
                  rel="prefetch"
                >
                  Introducing Content Collections: Type-Safe Markdown in Astro
                  2.0
                </a>
              </li>
              <li class="">
          ...
          <div class="p-6 lg:p-8 xl:p-10 lg:border-b border-gray-500 ">
            <h2 class="code ">Rewards</h2>
            <p class="body mb-6 mt-4 text-gray-200 ">Coins</p>
        ...
        <section class="mx-auto w-full px-4 lg:px-0">
          <div class="flex flex-col items-center gap-20 py-8 lg:p-12 xl:p-20 ">
            <ul class="flex max-w-screen-md flex-col gap-y-4 md:gap-y-6 lg:gap-y-8 ">
              <li class="">
                <article class="border border-gray-500 bg-[rgb(35,38,45)] p-5 outline-pink-light transition-transform duration-300 ease-out focus-within:outline hover:scale-[1.03]">
                  <a
                    href="/case-studies/contenda-share-pear/"
                    rel="prefetch"
                    class="block outline-none"
                  >
                    <header>
                      <time
                        class="code text-gray-200"
                    ...
                    {/* <img src="/_astro/cover-image.ba583d50.webp" width="725" height="241" alt="Content for Everyone" class="my-8" loading="lazy" decoding="async"> */}
                    ...
                    <div class="mt-6 grid gap-x-16 gap-y-4 md:grid-cols-2">
                      ...
                      <p class="text-gray-200">
                        How Astro Helped Contenda Build a Content-Sharing
              ...
              <li class="">
                <article class="border border-gray-500 bg-[rgb(35,38,45)] p-5 outline-pink-light transition-transform duration-300 ease-out focus-within:outline hover:scale-[1.03]">
                  ...
                  >
                    ...
                    {/* <img src="/_astro/blog-hero-image-updates.3feaf2f7.webp" width="1500" height="643" alt="Better Images in Astro" class="my-8" loading="lazy" decoding="async"> */}
                    ...
                    <div class="mt-6 grid gap-x-16 gap-y-4 md:grid-cols-2">
                      ...
                      <p class="text-gray-200">
                        A new feature brings built-in image optimization to
                        Astro. Coming in Astro 3.0, you can opt-in to try it
                        yourself in today. Images in Astro have been completely
                        redesigned with more features, faster performance, and a
                        better end-user experience with automatic layout shift
                        prevention.
                      </p>
                    </div>
                  </a>
              ...
              <li class="">
                <article class="border border-gray-500 bg-[rgb(35,38,45)] p-5 outline-pink-light transition-transform duration-300 ease-out focus-within:outline hover:scale-[1.03]">
                  ...
                  >
                    ...
                    {/* <img src="/_astro/webstorm-hero.5735f10b.webp" width="1500" height="643" alt="WebStorm announces official support for Astro" class="my-8" loading="lazy" decoding="async"> */}
                    ...
                    <div class="mt-6 grid gap-x-16 gap-y-4 md:grid-cols-2">
                      ...
                      <p class="text-gray-200">
                        WebStorm, the popular IDE for Javascript by JetBrains,
                        has announced initial support for Astro. Features
                        include syntax highlighting, code completion,
                        refactorings, navigation, intentions, code folding,
                        Emmet support, and correct formatting.
                      </p>
                    </div>
                  </a>
                </article>
            ...
            <nav aria-label="Pagination" class="mx-auto  D776PWUY">
              <ul class="flex items-center gap-4 D776PWUY">
                <li class="hidden sm:inline-block D776PWUY">
                  <a
                    href="/blog"
                    class="relative rounded-md w-10 h-10 flex items-center justify-center border border-transparent transition-colors duration-150 D776PWUY"
                    aria-current="page"
                  >
                    1
                  </a>
                ...
                <li class="hidden sm:inline-block D776PWUY">
                  <a
                    href="/blog/2"
                    class="relative rounded-md w-10 h-10 flex items-center justify-center border border-transparent transition-colors duration-150 hover:border-white focus:border-white D776PWUY"
                  >
                    2
                  </a>
                </li>
                ...
                <li class="sm:hidden D776PWUY">
                  <p aria-current="page" class="D776PWUY">
                    Page 1 of 4
                  </p>
                </li>
                <li class="next ease rounded-full border border-white transition-colors duration-150 D776PWUY">
                  <a
                    href="/blog/2"
                    rel="prefetch"
                    class="flex h-10 w-10 items-center justify-center D776PWUY"
                  >
                    <svg
                      data-hk="0-0"
                      width="24"
