...
const FirstQuestionnare = ({ nextStep, handleChange, score, setScore }) => {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={nextStep}
        className="button button-white max-w-xl w-full  relative bg-[#00febe] text-white inline-flex h-[3rem] items-center justify-center gap-[1rem] rounded-lg border-opacity-[1] border-[rgb(242,246,250,0.1)] px-[2.5rem] text-center text-xl font-[500] transition-all tracking-wide"
      >
        Next
      </button>
    </motion.div>
